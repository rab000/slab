//https://blog.csdn.net/jvandc/article/details/81335736
Shader "N/special/3d/toon/NRP2ToonTest2"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        //UsePass "NPR/NPR_CelShading/OUTLINE" //NTEMP
        ...
        {       
            ...
            fixed4 frag(v2f i) : COLOR
            {
                ...
                fixed w = lightTexColor.g;// * i.color.r;//NTEMP
